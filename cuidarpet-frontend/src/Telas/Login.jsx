...
export default function Login() {
  ...
  const handleLogin = async (e) => {
    ...
    try {
      ...
      setErro(err.response?.data?.mensagem || 'Matrícula ou senha inválidos');
    } finally {
      setLoading(false);
    }
  };
  ...
  return (
    <div className="min-h-screen bg-[#f3faff] flex items-center justify-center p-4 relative overflow-hidden">
      ...
      <div className="fixed inset-0 pointer-events-none opacity-10">
        <span className="material-symbols-outlined absolute text-[240px] -top-20 -left-20 text-[#964900] -rotate-12">pets</span>
        <span className="material-symbols-outlined absolute text-[180px] bottom-10 -right-10 text-[#006b5e] rotate-12">medical_services</span>
      </div>
        ...
        <div className="bg-white/95 backdrop-blur-md shadow-xl rounded-2xl p-8 border border-orange-100 flex flex-col items-center">
          ...
          <div className="mb-8 flex flex-col items-center gap-2">
            ...
            <div className="text-center">
              <h1 className="text-3xl font-bold text-primary tracking-tight">CuidarPet</h1>
              <p className="text-on-surface-variant font-medium">Clínica Veterinária</p>
            </div>
          </div>
          ...
          <form onSubmit={handleLogin} className="w-full space-y-5">
            <div>
              ...
              <div className="relative group">
                <span className="material-symbols-outlined absolute left-3 top-1/2 -translate-y-1/2 text-gray-400 group-focus-within:text-primary-container transition-colors">badge</span>
                <input 
                  type="text" 
            ...
            <div>
              ...
              <div className="relative group">
                <span className="material-symbols-outlined absolute left-3 top-1/2 -translate-y-1/2 text-gray-400 group-focus-within:text-primary-container transition-colors">lock</span>
                <input 
                  type={verSenha ? "text" : "password"} 
                  className="w-full pl-10 pr-12 py-3 bg-gray-50 border border-gray-200 rounded-xl outline-none focus:ring-2 focus:ring-primary-container/20 focus:border-primary-container transition-all"
                  value={senha}
            ...
            <button 
              type="submit" 
              disabled={loading}
              className="w-full py-3.5 bg-primary-container text-white font-bold rounded-xl shadow-lg shadow-orange-200 hover:bg-orange-600 transition-all active:scale-[0.98] disabled:opacity-70 flex items-center justify-center gap-2"
            >
